...
public class SandcastleTest {
    ...
    public void testInteractWithCompleted(){
        ...
        SandCastle sandCastle = new SandCastle(new Point(), new RectangleFactoryAdapterStub(), questManager, weaponRepository);
        assertTrue("SandCastle was interacted", sandCastle.getInteractedWith());
        sandCastle.onInteract(player);
        assertTrue("SandCastle was interacted", sandCastle.getInteractedWith());
    }
