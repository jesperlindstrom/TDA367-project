...
public class Rekoil extends AbstractNPCModel {
    ...
    public Rekoil(Point point, IRectangleFactoryAdapter rectangleFactory, List<String> phrases, int width, int height) {
    ...
    public Rekoil(Point point, IRectangleFactoryAdapter rectangleFactory, List<String> phrases) {
        this(point, rectangleFactory, phrases, 90, 158);
    }
